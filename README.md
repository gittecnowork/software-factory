...
Las reglas **20 a 23, y la 25 y la 26**, son sobre **cómo tiene que estar escrito un pedido** para que se pueda ejecutar. No describen el trabajo: describen el encargo. Un pedido que las incumple se devuelve corregido, no se ejecuta adivinando. La lista no se agrupa por tema —crece en el orden en que se pagó cada regla, y los números no se reciclan porque las skills y los mensajes de commit las citan—, así que el bloque no es continuo: la 24 está en el medio y es de las otras.
